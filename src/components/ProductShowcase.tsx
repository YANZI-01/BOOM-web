...
export function ProductShowcase() {
  ...
  return (
    <section ref={containerRef} className="relative w-full h-screen bg-black overflow-hidden flex items-center justify-center perspective-[1000px]">
      ...
      <div className="relative z-10 w-full flex flex-col items-center justify-center pointer-events-none">
        ...
        >
          ...
          <div className="w-48 h-72 md:w-64 md:h-96 rounded-[75px] md:rounded-[100px] border border-white/20 bg-gradient-to-br from-[#222] via-[#050505] to-[#111] shadow-[0_40px_80px_rgba(0,0,0,0.8),inset_0_2px_10px_rgba(255,255,255,0.2)] flex items-center justify-center relative overflow-hidden backdrop-blur-2xl">
              ...
              {/* Brand Logo */}
              <div className="absolute bottom-10 left-1/2 -translate-x-1/2 tracking-[0.3em] text-white/50 text-xs font-display font-medium">BOOM</div>
          </div>
          ...
          <svg 
            ...
            fill="none"
          >
            <path id="device-contour" d="M 0 100 L 0 316 A 132 132 0 0 0 132 448 L 188 448 A 132 132 0 0 0 320 316 L 320 100" />
            <text fill="currentColor" className="text-boom-text-dim text-[14px] md:text-[18px] font-medium tracking-[0.2em] font-sans">
              <textPath href="#device-contour" startOffset="50%" textAnchor="middle">
                {t('顶级AI教练，看得见你的进步时机', 'Top AI Coach, sees the timing of your progress.')}
              </textPath>
            </text>
            <text fill="currentColor" className="text-boom-green text-[12px] md:text-[14px] font-bold tracking-[0.2em] font-sans filter drop-shadow-[0_0_8px_rgba(163,230,53,0.8)]" dy="28">
              <textPath href="#device-contour" startOffset="50%" textAnchor="middle">
        ...
        <div ref={textRef} className="absolute inset-0 flex flex-col md:block items-center justify-center pointer-events-none z-20">
